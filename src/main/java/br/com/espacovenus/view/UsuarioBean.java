...
import br.com.espacovenus.model.Usuario;
...
public class UsuarioBean implements Serializable
{
   ...
   private Predicate[] getSearchPredicates(Root<Usuario> root)
   {
      ...
      String sobrenome = this.example.getSobrenome();
      if (sobrenome != null && !"".equals(sobrenome))
      {
         predicatesList.add(builder.like(root.<String> get("sobrenome"), '%' + sobrenome + '%'));
      }
      ...
      String telefoneCelular = this.example.getTelefoneCelular();
      if (telefoneCelular != null && !"".equals(telefoneCelular))
      {
         predicatesList.add(builder.like(root.<String> get("telefoneCelular"), '%' + telefoneCelular + '%'));
      }
      String telefoneCasa = this.example.getTelefoneCasa();
      if (telefoneCasa != null && !"".equals(telefoneCasa))
      {
         predicatesList.add(builder.like(root.<String> get("telefoneCasa"), '%' + telefoneCasa + '%'));
      }
